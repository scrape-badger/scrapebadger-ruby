...
# Unit tests for ScrapeBadger::WebhookTestResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe ScrapeBadger::WebhookTestResponse do
  let(:instance) { ScrapeBadger::WebhookTestResponse.new }

  describe 'test an instance of WebhookTestResponse' do
    it 'should create an instance of WebhookTestResponse' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(ScrapeBadger::WebhookTestResponse)
    end
  end
